 ...
 */
class getIdentRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\IdentRepository' shared autowired service.
     *
     * @return \App\Repository\IdentRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'IdentRepository.php';

        return $container->privates['App\\Repository\\IdentRepository'] = new \App\Repository\IdentRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
